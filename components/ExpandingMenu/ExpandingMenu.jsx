...
const ExpandingMenu = ({ className = '' }) => {
    return (
        <div className={`expanding-menu-wrapper ${className}`}>
            <div className="expanding-menu">
                <a href="#" className="expanding-menu__link">
                    <span className="expanding-menu__icon">
                    ...
                    <span className="expanding-menu__title">Home</span>
                </a>
                <a href="#" className="expanding-menu__link">
                    <span className="expanding-menu__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width={192} height={192} fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <span className="expanding-menu__title">Games</span>
                </a>
                <a href="#" className="expanding-menu__link">
                    <span className="expanding-menu__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width={192} height={192} fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <span className="expanding-menu__title">Chat</span>
                </a>
                <a href="#" className="expanding-menu__link">
                    <span className="expanding-menu__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width={192} height={192} fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <span className="expanding-menu__title">Search</span>
                </a>
                <a href="#" className="expanding-menu__link">
                    <span className="expanding-menu__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width={192} height={192} fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <span className="expanding-menu__title">Profile</span>
                </a>
            </div>
        </div>
    );
