...
const JSONPathNode = ({ id, data, isConnectable }) => {
    const fields = data.fields || [{ name: '', path: '', mode: 'get' }];

    const handleAddField = () => {
        const newFields = [...fields, { name: '', path: '', mode: 'get' }];
    ...
    return (
        <div className="json-path-node">
            ...
            <div className="node-header">
                ...
                <div className="node-title">JSON Path Helper</div>
            </div>
            ...
            <div className="node-body">
                ...
                <div className="info-text">
                    JSON Filter ⚡
                    <br />
                    <small>Extract from JSON using Path</small>
                </div>
            </div>
            ...
            <style jsx>{`
                ...
                input:focus, select:focus { outline: none; border-color: #fbbf24; background: white; }
...
export default memo(JSONPathNode);
