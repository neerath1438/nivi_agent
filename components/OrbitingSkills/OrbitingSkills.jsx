...
const iconComponents = {
  html: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="orbiting-skills-icon">
        <path
  ...
  react: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="none" className="orbiting-skills-icon">
...
const OrbitingSkill = memo(({ config, angle }) => {
  ...
  return (
    <div
      className={`orbiting-skill ${isHovered ? 'orbiting-skill-hovered' : ''}`}
      style={{
        width: `${size}px`,
        height: `${size}px`,
    ...
    >
      <div
        className={`orbiting-skill-icon ${isHovered ? 'orbiting-skill-icon-hovered' : ''}`}
        style={{
          boxShadow: isHovered
      ...
      >
        ...
        {isHovered && (
          <div className="orbiting-skill-label">{label}</div>
        )}
      </div>
    </div>
  )
...
const GlowingOrbitPath = memo(({ radius, glowColor = 'cyan', animationDelay = 0 }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="orbiting-path-border"
        style={{
...
export default function OrbitingSkills() {
  ...
  return (
    <main className="orbiting-skills-container">
      <div className="orbiting-skills-background" />
      <div
        className="orbiting-skills-orbit-container"
        onMouseEnter={() => setIsPaused(true)}
        onMouseLeave={() => setIsPaused(false)}
      >
        <div className="orbiting-skills-center">
          <div className="orbiting-skills-center-glow orbiting-skills-center-glow-cyan" />
          <div className="orbiting-skills-center-glow orbiting-skills-center-glow-purple" />
